...
describe('standard ngram tokenizer', () => {
  const standardNGramTokenizer = nGramTokenizerCreater({ min: 2, max: 3, analyzer: 'standard' });
...
describe('asciifolding ngram tokenizer', () => {
  const asciifoldingNGramTokenizer = nGramTokenizerCreater({ min: 2, max: 3, analyzer: 'asciifolding' });
